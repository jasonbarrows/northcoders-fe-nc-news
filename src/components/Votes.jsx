const Votes = ({ count }) => {
  return (
    <div className="border flex items-center rounded-full overflow-hidden">
      <button className="p-1 text-rose-700 active:bg-neutral-200" aria-label="Vote up">
      ...
      <button className="p-1 text-rose-700 active:bg-neutral-200" aria-label="Vote down">
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" width="20" height="20" fill="currentColor" className="w-5 h-5">
